...
public class MultiControlerBase : MonoBehaviour
{
    ...
    public void sliderControl(float sd_value,int sliderIndex)
    {
        int cp = (int)(controlPointRange * sd_value) + 1;
        if(cp>controlPointRange)
        {
            cp = controlPointRange;
        }
        controlPointList[sliderIndex] = cp;
    }
