...
public class RightBoardCtrl_VR_T3 : MonoBehaviour {
    ...
    void Start () {
        ...
        for (i = 0; i < count; i++)
        {
            if (i > 0)              //向下排列按钮
            {
                ...
                for (j = 0; j < num; j++)
                {
                    child[j] = transform.GetChild(j).gameObject;
                }
        ;
                for (j = 0; j < num; j++)
                {
                    ...
                    {
                        child[j].transform.parent = gameObject.transform.parent;
                    }
                }
                ...
                for (j = 0; j < num; j++)
                {
                    ...
                    {
                        child[j].transform.parent = transform;
                    }
                }
            }
        ...
        detailButton.transform.parent = transform.parent;
